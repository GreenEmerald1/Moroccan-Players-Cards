const BestSeasons = {"Achraf Hakimi 🇲🇦⚡" : ["Paris Saint-Germain - France","2023-2024", "hakimi.PNG" ], "Yassine Bounou 🧤🦁":["Sevilla - Spain", "2022 - 2023", "bounou.PNG"], "Nayef Aguerd 🛡️🔥":["Westham - England", "2022 - 2023", "aguerd.PNG"], "Romain Saïss 🏋️‍♂️🦁" :["Wolverhampton - England", "2019 - 2020", "Saiss.PNG"],"Noussair Mazraoui 🚀🎯":["Ajax - Netherlands" , "2017 - 2018", "mazraoui.PNG"],"Sofyan Amrabat 💪🛡️":["Manchester United - England", "2023 - 2024", "amrabat.PNG"], "Azzedine Ounahi 🌟🔥":["Angers Sporting - France", "2021 - 2022", "ounahi.PNG"], "Selim Amallah ⚽💥":["Valladolid - Spain", "2022 - 2023", "amallah.PNG"], "Hakim Ziyech 🎯⚽":["Ajax - Netherlands", "2016 - 2017", "ziyech.PNG"], "Youssef En-Nesyri ⚽🔥":["Sevilla - Spain", "2022 - 2023", "ennesyri.PNG"] , "Boufal Sofiane 🦋🎨":["Lille LOSC - France", "2010 - 2011", "boufal.PNG"]}
...
function execute(player) {
  if (BestSeasons[player]) {
    ...
    const profileHTML = `
      <div class="wrapper">
        <div class="profilecard">
          <div class="img">
            <img src="${image}" alt="${player}" class="imag3">
          </div>
          <div class="infos">
          ...
          <div class="buttoncontainer">
            <button id="exit" onclick="goBack()"><h4 id="h5">Back</h4></button>
          </div>
        </div>
      </div>
    `;
    ...
    document.querySelector(".wrappingall").style.display = "none";
  } else {
...
function goBack() {
  document.querySelector(".profile-container").innerHTML = ""; // Supprime la fiche joueur
  document.querySelector(".wrappingall").style.display = "block";
  scrollToDiv("id1");
   // Réaffiche le contenu principal
}
